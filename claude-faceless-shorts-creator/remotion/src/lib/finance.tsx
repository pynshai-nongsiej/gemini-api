...
/** ALL-CAPS banner burned over frame 0 (hook rule: the thumbnail IS frame 0) */
export const HookCard: React.FC<{ text: string; accent: string }> = ({ text, accent }) => {
  ...
  return (
    <AbsoluteFill style={{ justifyContent: 'flex-start', alignItems: 'center', paddingTop: 170, opacity: fade }}>
      <div style={{
